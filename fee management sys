...
class student
{
	int rollno;
	char name[50];
	int Tution_fee, hostel_fee, bus_fee, mess_fee;
	char date[10];
	int total;
	void calculate();	
public:
...
{
	total = Tution_fee + hostel_fee + bus_fee + mess_fee;
}
...
{
	cout<<rollno<<setw(4)<<" "<<name<<setw(12)<<Tution_fee<<setw(18)<<date<<setw(15)<<hostel_fee<<setw(10)<<bus_fee<<setw(12)<<mess_fee<<setw(10)<<total<<setw(10)<<endl;
}
...
void total_fee()
{
	...
	cout<<"\n\n\t\tALL STUDENTS FEES \n\n";
	cout<<"====================================================================================================================\n";
	cout<<"R.No   	Name          	 Tution fee 	 Submission Date 	  Hostel fee     Bus fee   Mess fee   Total "<<endl;
	cout<<"====================================================================================================================\n";
	while(inFile.read(reinterpret_cast<char *> (&st), sizeof(student)))
	{
		st.show_tabular();
...
void intro()
{
	...
	cout<<"\n\n\t\t\t\t        FEES MANAGEMENT";
	cout<<"\n\n\t\t\t\t\t      PROJECT";
	cout<<"\n\n\n\t\tMADE BY : Manpreet Rathore-1CR18CS096 (D-12)";
